...
# (The prompt itself is powerlevel10k's job — see ~/.p10k.zsh.)

# --- Catppuccin Mocha palette (256/truecolor) ---------------------------
# Used by any script that wants consistent colours.
